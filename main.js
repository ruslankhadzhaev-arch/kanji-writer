...
var VERSION = "2.0";
var getCharDataUrl = (char) => `https://raw.githubusercontent.com/ruslankhadzhaev-arch/kanji-writer/main/data/${char}.json`;
...
var HanziWriterPlugin = class extends import_obsidian.Plugin {
  async onload() {
    this.registerMarkdownCodeBlockProcessor("kanji-writer", (source, el, ctx) => {
